      ...
      <div className="container-premium relative z-10">
        <div className="max-w-3xl mx-auto sm:text-center">
          ...
          >
            <Link
              href="/contact"
              className="group px-8 py-4 text-center bg-[#C5A85C] text-[#1C2340] font-medium rounded-lg transition-all duration-300 hover:shadow-[0_10px_40px_rgba(197,168,92,0.3)] hover:-translate-y-1"
            >
            ...
            <Link
              href="/foundation"
              className="group px-8 py-4 border text-center border-[#C5A85C]/40 text-[#C5A85C] font-medium rounded-lg transition-all duration-300 hover:bg-[#C5A85C]/10 hover:border-[#C5A85C] hover:-translate-y-1"
            >
            ...
            <Link
              href="/contact"
              className="group px-8 py-4 border text-center border-white/20 text-[#F1F3F8] font-medium rounded-lg transition-all duration-300 hover:bg-white/5 hover:border-white/40 hover:-translate-y-1"
            >
              Media Inquiry
            </Link>
          </motion.div>
